...
SOURCEFILES_QUOTED_IF_SPACED=Lab_3_main.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Lab_3_main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Lab_3_main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Lab_3_main.o

# Source Files
SOURCEFILES=Lab_3_main.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Lab_3_main.o: Lab_3_main.s  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Lab_3_main.o 
	@${FIXDEPS} "${OBJECTDIR}/Lab_3_main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -D__DEBUG  -D__MPLAB_DEBUGGER_PK3=1 -c -mprocessor=$(MP_PROCESSOR_OPTION)  -o ${OBJECTDIR}/Lab_3_main.o Lab_3_main.s  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,--gdwarf-2,-MD="${OBJECTDIR}/Lab_3_main.o.d"
else
${OBJECTDIR}/Lab_3_main.o: Lab_3_main.s  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Lab_3_main.o 
	@${FIXDEPS} "${OBJECTDIR}/Lab_3_main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION)  -o ${OBJECTDIR}/Lab_3_main.o Lab_3_main.s  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),--gdwarf-2,-MD="${OBJECTDIR}/Lab_3_main.o.d"
endif
